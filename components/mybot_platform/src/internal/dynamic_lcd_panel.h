...
#ifndef MYBOT_DYNAMIC_LCD_PANEL_H_
#define MYBOT_DYNAMIC_LCD_PANEL_H_
...
typedef struct {
    ...
    bool ready;
} mybot_dynamic_lcd_panel_t;

int mybot_amoled175_lvgl_panel_open(mybot_dynamic_lcd_panel_t *panel,
                                    esp_lcd_panel_io_color_trans_done_cb_t callback,
                                    void *user_data);
int mybot_amoled175_lvgl_panel_close(mybot_dynamic_lcd_panel_t *panel);
...
#endif /* MYBOT_DYNAMIC_LCD_PANEL_H_ */
