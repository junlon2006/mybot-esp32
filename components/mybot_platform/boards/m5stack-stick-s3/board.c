...
static void board_on_provisioning(const char *trigger) {
    ...
    (void)mybot_embedded_ogg_play_wifi_provisioning(mybot_sticks3_audio_playback_ops(),
                                                    mybot_sticks3_audio_volume_ops(), trigger);
}
...
static int board_register_platform(void) {
    const mybot_platform_descriptor_t descriptor = {
        ...
        .audio_capture = mybot_sticks3_audio_capture_ops(),
        .audio_playback = mybot_sticks3_audio_playback_ops(),
