...
当前支持征辰 1.54 TFT ML307 与 Wi-Fi profile、M5Stack CoreS3、M5Stack StickS3，以及
搭配 XIAO ESP32S3 的 ReSpeaker Flex XVF3800 Circular-4 和 SenseCAP Watcher 的 Wi-Fi
固件路径。征辰 Wi-Fi profile 已覆盖构建验证，但仍需完成真机验证。在实现并验证兼容网络
路径之前，ML307/4G 相关问题按特性请求处理。
