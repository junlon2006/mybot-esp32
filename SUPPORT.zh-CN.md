...
当前支持征辰 1.54 TFT ML307、M5Stack CoreS3、M5Stack StickS3，以及搭配 XIAO ESP32S3
的 ReSpeaker Flex XVF3800 Circular-4 和 SenseCAP Watcher 的 Wi-Fi 固件路径。在实现并验证兼容网络路径
